          ...
          <div className="relative min-h-[400px] flex items-center justify-center animate-fade-up">
            ...
            {partners.map((p, i) => (
              ...
              >
                ...
                <div className="absolute -z-10 w-24 h-24 bg-[#49A5BD]/5 blur-xl md:blur-2xl rounded-full opacity-0 group-hover:opacity-100 transition-opacity" />
              </motion.div>
            ))}

            {/* Background Glow */}
            <div className="absolute w-64 h-64 bg-[#49A5BD]/5 blur-3xl md:blur-[100px] rounded-full -z-10" />
          </div>
