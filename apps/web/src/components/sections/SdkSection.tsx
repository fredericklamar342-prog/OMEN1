...
export function SdkSection() {
  return (
    <section id="developer" className="py-24 md:py-64 relative z-10 bg-[#FFFFFF] border-t-2 border-[#49A5BD]/10 text-[#49A5BD]" aria-labelledby="sdk-title">
      <div className="max-container relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-32 items-center">
          <div className="space-y-8 md:space-y-10 animate-fade-up">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#FFFFFF] border-2 border-[#49A5BD] rounded-full">
             ...
             <div className="space-y-6 md:space-y-8">
              <h2 id="sdk-title" className="text-4xl sm:text-5xl md:text-6xl font-black tracking-tighter text-[#49A5BD] uppercase font-outfit leading-[0.95]">
                Simple to <span className="text-[#49A5BD]">Integrate.</span>
              </h2>
              <p className="text-lg md:text-xl text-[#49A5BD] leading-relaxed font-bold tracking-tight opacity-90">
            ...
            <div className="grid grid-cols-2 gap-6 sm:gap-8">
              {[
                ...
                <div key={i} className="space-y-1">
                  ...
                  <div className="text-base md:text-lg font-bold text-[#49A5BD]">{stat.val}</div>
                </div>
              ))}
            </div>

            <div className="pt-4">
              <Button size="lg" className="w-full sm:w-auto h-14 px-8 text-base font-bold bg-[#49A5BD] hover:bg-[#49A5BD]/90 text-[#FFFFFF] rounded-xl transition-all group border-none" asChild>
          ...
          <div className="relative animate-fade-up mt-8 lg:mt-0">
            <div className="glass-card rounded-2xl border-2 border-[#49A5BD] p-0 font-mono text-sm relative overflow-hidden bg-[#FFFFFF]">
              {/* Terminal Header */}
              <div className="flex items-center justify-between px-5 sm:px-6 py-4 border-b-2 border-[#49A5BD] bg-[#FFFFFF]">
                <div className="flex gap-2">
                  <div className="w-3 h-3 rounded-full border-2 border-[#49A5BD] bg-[#FFFFFF]" />
                  <div className="w-3 h-3 rounded-full border-2 border-[#49A5BD] bg-[#FFFFFF]" />
                  <div className="w-3 h-3 rounded-full border-2 border-[#49A5BD] bg-[#FFFFFF]" />
                </div>
                <div className="text-[9px] sm:text-[10px] text-[#49A5BD] font-bold tracking-widest uppercase font-sans">omen-sdk-integration.ts</div>
              </div>
              
              <div className="p-6 sm:p-8 bg-[#FFFFFF]">
                <div className="text-[12px] sm:text-[14px] leading-relaxed font-mono text-[#49A5BD] overflow-x-auto whitespace-pre custom-scrollbar">
...
if (trustScore < 85) {
  abortTransaction()
                ...
                <div className="mt-8 md:mt-12 pt-6 border-t-2 border-[#49A5BD]/20">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-2 h-2 rounded-full bg-[#49A5BD]" />
                    <span className="text-[9px] sm:text-[10px] font-mono font-bold uppercase text-[#49A5BD] tracking-widest">Omen Security Firewall Active</span>
                  </div>
                  <div className="font-mono text-[10px] sm:text-[11px] text-[#49A5BD] space-y-2 sm:space-y-1 opacity-70">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span>&gt; Checking protocol reputation on</span>
                      <WalrusIcon className="w-3.5 h-3.5" /> 
                      <span className="font-bold">Walrus...</span>
                    </div>
                    <div className="text-[#49A5BD] font-black opacity-100 break-words">&gt; Verification: [92/100] INSTITUTIONAL GRADE</div>
                  </div>
                </div>
              </div>
            </div>
