    ...
    <Layout>
      <div className="relative min-h-[80vh] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="max-container w-full flex flex-col items-center text-center px-4 relative z-10">
          <div className="w-20 h-20 rounded-full bg-white border border-[#2B5C92]/10 flex items-center justify-center mb-8 shadow-sm">
            <BookOpen className="w-8 h-8 text-[#2B5C92]" />
          </div>
          ...
          <div className="mt-20 flex items-center gap-2 px-4 py-2 rounded-full border border-[#2B5C92]/10 bg-white/50 backdrop-blur-sm shadow-sm animate-pulse">
            <Sparkles className="w-4 h-4 text-[#2B5C92]" />
            <span className="text-[11px] font-bold uppercase tracking-widest text-[#2B5C92]/70">
